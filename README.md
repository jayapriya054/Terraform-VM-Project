...
***Used Terraform to create AWS infrastructure and deployed a containerized application in a preview environment for testing before staging or production.***
